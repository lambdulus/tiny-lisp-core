    ...
    static toString(token) {
        switch (token) {
            ...
            case LexerTokens_1.LexerToken.define:
                return "define";
            case LexerTokens_1.LexerToken.defBasicMacro:
            case LexerTokens_1.LexerToken.defHygMacro:
                return "def-macro";
            case LexerTokens_1.LexerToken.struct:
            ...
            case LexerTokens_1.LexerToken.begin:
                return "begin";
            case LexerTokens_1.LexerToken.printf:
